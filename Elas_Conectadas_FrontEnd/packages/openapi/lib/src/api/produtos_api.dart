...
class ProdutosApi {
  ...
  const ProdutosApi(this._dio, this._serializers);
  ...
  Future<Response<ProdutoResponseDto>> produtosCreate({ 
    ...
    try {
      const _type = FullType(CreateProdutoDto);
      _bodyData = _serializers.serialize(createProdutoDto, specifiedType: _type);
  ...
  Future<Response<ProdutoResponseDto>> produtosFindOne({ 
    ...
    final _path = r'/produtos/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
