...
import 'package:openapi/src/api/produtos_api.dart';
...
class Openapi {
  ...
  /// Get ProdutosApi instance, base route and serializer can be overridden by a given but be careful,
  /// by doing that all interceptors will not be executed
  ProdutosApi getProdutosApi() {
    return ProdutosApi(dio, serializers);
  }
